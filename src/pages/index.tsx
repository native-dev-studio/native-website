      ...
      <div className='grid-container'>
        <div className='lg:grid lg:grid-cols-10 lg:gap-x-9 lg:col-start-2 lg:col-span-10'>
          <section className='lg:col-start-4 lg:col-span-7 lg:my-10'>
            ...
            <p>
              Native is not just any studio that helps companies build products on Web3. Discover what makes us an effective partner for industry leaders like a16z and ConsenSys on their next big crypto project.
            </p>
          </section>
          <section className='
            ...
            <figure className='bg-black my-5'>
              ...
              <div className='lg:grid lg:grid-cols-10 lg:gap-x-9'>
                ...
                <p className='col-start-4 col-span-6'>
                  The future of sports goes beyond watching TV. In Dream Fight, users engage in a new type of game augmented over live sports broadcast.&nbsp;
